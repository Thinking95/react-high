...
const Footer = () => {
  ...
  return (
    <footer ref={ref} className="footer-distributed">
        <motion.div animate={animation} className="footer-left">
        <div className="n-names">PuzzleX</div>
        ...
        <motion.div animate={animete} className="footer-center">
            <div>
                <a><BiMap /></a> 
                <p><span>Sanchaung Tsp, </span>Yangon</p>
            </div>
            <div>
                <a><BsTelephone/></a>
                <p>+959778173272</p>
            ...
            <div>
                <a><BiEnvelope/></a>
                <p>thinkingsai@gmail.com</p>
            </div>
        </motion.div>

        <motion.div animate={ani} className="footer-right">
            <p className="love">
                <span>Love To Code!</span>
                <strong>We</strong> Collaborate with ambitious brands and people;
